...
@section('scripts')
    ...
    <script type="text/javascript"
            src="{{ asset('js/requirements/index.js') }}" defer></script>
@endsection
...
@section('styles')
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('css/requirements/index.css') }}">
@endsection
                ...
                <div class="card">
                    <div class="card-body row">
                        ...
                        <div class="small-view col-md-4">
                            <img src="{{ asset("images/views-right-panels")."/Requirements_Right_Panel.png" }}"
                                 alt="RequirementsPageRightPanel" class="requirements_page_right_panel_img">
                            <div class="requirements_page_right_panel">
                                <div class="form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 form-input update-requirement-div p-2">
                                            <button class="btn btn-outline-success w-100 mb-1 show-requirement-btn">
                                                <i class="fas fa-eye"></i> @lang('dictionary.actions.show')
                                            </button>
                                            <button class="btn btn-outline-info w-100 mb-1 edit-requirement-btn">
