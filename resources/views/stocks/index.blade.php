...
@section('scripts')
    ...
    <script type="text/javascript"
            src="{{ secure_asset('js/stocks/index.js') }}" defer></script>
@endsection
...
@section('styles')
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ secure_asset('css/stocks/index.css') }}">
@endsection
                ...
                <div class="card">
                    <div class="card-body row">
                        ...
                        <div class="small-view col-md-4">
                            <img src="{{ secure_asset("images/views-right-panels")."/Stocks_Right_Panel.png" }}"
