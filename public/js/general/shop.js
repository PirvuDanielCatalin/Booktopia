...
function configLeafletMap() {
    var mymap = L.map('leaflet-map').invalidateSize().setView([44.4306476, 26.051922699999977], 14);
...
function configLeafletMapModal() {
    var mymap = L.map('leaflet-map-modal').invalidateSize().setView([44.4306476, 26.051922699999977], 14);
    L.tileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        maxZoom: 18,
        attribution: '',
        id: 'mapbox.streets'
